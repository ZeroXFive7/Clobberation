...
//	DebugDrawStuff();
	...
	var v = Input.GetAxisRaw("VerticalRight");
	var h = Input.GetAxisRaw("HorizontalRight");

	var isPanning = Mathf.Abs(h) > 0.1;
	...
	if (isPanning)
	{
		...
		Mathf.MoveTowardsAngle(targetAngle, targetAngle + h, 1.0);
